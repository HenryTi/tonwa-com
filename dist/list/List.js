...
function List(props) {
    ...
    var onItemNav;
    if (onItemClick) {
        onItemNav = function (item) { return __awaiter(_this, void 0, void 0, function () {
            var ret;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, onItemClick(item)];
                    case 1:
                        ret = _a.sent();
                        if (ret) {
                            navigate(ret);
    ...
    if (onItemSelect) {
        if (onItemNav) {
            renderItem = function (v) { return ((0, jsx_runtime_1.jsxs)("div", __assign({ className: "d-flex" }, { children: [(0, jsx_runtime_1.jsx)("label", __assign({ className: "ps-3 pe-2 align-self-stretch d-flex align-items-center" }, { children: (0, jsx_runtime_1.jsx)("input", { type: "checkbox", className: "form-check-input", onChange: function (evt) { return onCheckChange(v, evt); } }, void 0) }), void 0), (0, jsx_runtime_1.jsx)("div", __assign({ className: "flex-grow-1 cursor-pointer", onClick: function () { return onItemNav(v); } }, { children: (0, jsx_runtime_1.jsx)(ItemView, { value: v }, void 0) }), void 0)] }), void 0)); };
        }
        else {
        ...
        renderItem = function (v) {
            var funcClick, cn;
            if (onItemNav) {
                funcClick = function () { return onItemNav(v); };
